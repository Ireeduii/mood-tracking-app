...
const moods: MoodOption[] = [
  { id: "happy", label: "Happy", color: "bg-mood-happy" },
  { id: "stressed", label: "Stressed", color: "bg-mood-stressed" },
  { id: "calm", label: "Calm", color: "bg-mood-calm" },
  {
    id: "energetic",
  ...
  { id: "low", label: "Low", color: "bg-mood-low" },
];
